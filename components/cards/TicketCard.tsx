...
export const TicketCard: React.FC<TicketItem> = ({ title, details, style }) => {
  return (
    <div
      className="absolute bg-[#f1ede9] w-80 shadow-lg text-[#544c44] p-4 flex flex-col gap-2 transition-transform duration-300 hover:scale-110 hover:z-20"
      style={{
        ...style,
    ...
    >
      <div className="absolute top-2 left-1/2 -translate-x-1/2 w-20 h-4 bg-white/30 backdrop-blur-sm"></div>
